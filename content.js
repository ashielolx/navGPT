...
// create and apply classes to the initial set of buttons
function createButtons() {
  const svgRight = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><path fill="currentColor" d="M5 4v5.022a5.48 5.48 0 0 0-1 .185V4a2 2 0 0 1 2-2h4.586a1.5 1.5 0 0 1 1.06.44l3.915 3.914A1.5 1.5 0 0 1 16 7.414V16a2 2 0 0 1-2 2H9.743c.253-.307.474-.642.657-1H14a1 1 0 0 0 1-1V8h-3.5A1.5 1.5 0 0 1 10 6.5V3H6a1 1 0 0 0-1 1m8.5 11h-2.522a5.586 5.586 0 0 0 0-1H13.5a.5.5 0 0 1 0 1m0-2h-2.707a5.467 5.467 0 0 0-.393-1h3.1a.5.5 0 0 1 0 1m0-2H9.743a5.533 5.533 0 0 0-1.08-1H13.5a.5.5 0 0 1 0 1m1.293-4L11 3.207V6.5a.5.5 0 0 0 .5.5zM5.5 19a4.5 4.5 0 1 1 0-9a4.5 4.5 0 0 1 0 9m-2.353-4.854l-.003.003a.498.498 0 0 0-.144.348v.006a.498.498 0 0 0 .146.35l2 2a.5.5 0 0 0 .708-.707L4.707 15H7.5a.5.5 0 0 0 0-1H4.707l1.147-1.146a.5.5 0 0 0-.708-.708z"/></svg>`;
  const svgToTop = `<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  `;
  const svgToMid = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><path fill="currentColor" d="M13.5 9a.5.5 0 0 0 0-1h-7a.5.5 0 0 0 0 1zm0 3a.5.5 0 0 0 0-1h-7a.5.5 0 0 0 0 1zm4.5-2a8 8 0 1 0-16 0a8 8 0 0 0 16 0m-8-7a7 7 0 1 1 0 14a7 7 0 0 1 0-14"/></svg>`;
  const svgToBottom = `<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const btnToTop = document.createElement("div");
  btnToTop.className = "btn-totop";
  btnToTop.innerHTML = svgToTop;
  document.body.appendChild(btnToTop);

  const btnToMid = document.createElement("div");
  btnToMid.className = "btn-tomid";
  btnToMid.innerHTML = svgToMid;
  document.body.appendChild(btnToMid);

  const btnToBottom = document.createElement("div");
  btnToBottom.className = "btn-tobottom";
  btnToBottom.innerHTML = svgToBottom;
  document.body.appendChild(btnToBottom);
}
